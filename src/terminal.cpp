...
void Terminal::print_help() const {
    ...
    write("  /compact              Compress the conversation into a summary\n");
    write("  /stats                Show prompt/generation statistics\n");
    ...
    write("  /clear-memories       Remove all persistent memories\n");
    ...
    write("  /temp <value>         Change sampling temperature (/temperature)\n");
    ...
    write("  /n <value>            Change maximum generated tokens (/n-predict)\n");
